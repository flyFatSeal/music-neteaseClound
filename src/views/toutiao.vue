<template>
  <div title="Scroll" class="toutiao">
    <template slot="content">
      <header ref="topHeader">
        <img src="https://dpubstatic.udache.com/static/dpubimg/0K9-YvWB-Q/toutiao_header2.png">
      </header>
      ...
      <footer ref="footer">
        <img src="https://dpubstatic.udache.com/static/dpubimg/1KRE2YnAim/toutiao_footer2.png">
      </footer>
    </template>
  </div>
</template>
